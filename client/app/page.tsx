...
export default async function Home() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden">
      ...
      <div className="card-gradient max-w-md w-full mx-4 relative z-10 animate-fade-in">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8 text-lg">
            Modern Banking Made Simple & Secure
          </p>
          ...
          <div className="space-y-4">
            <Link
              ...
              className="btn btn-primary w-full block text-center hover-lift"
            >
            ...
            <Link
              href="/register"
              className="btn btn-secondary w-full block text-center hover-lift"
            >
              <svg className="w-5 h-5 inline mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
